...
prompts=("prompt1_longest" "prompt1_gpt_best" "prompt2_cat3" "prompt2_cat4")
# prompts=("prompt1_tf_idf" "prompt1_semantic_centroid" "prompt1_random"  "prompt2_cat2" "prompt2_cat5" "prompt2_sum")
...
python model_training.py --prompt ${prompts[$SLURM_ARRAY_TASK_ID]} 
